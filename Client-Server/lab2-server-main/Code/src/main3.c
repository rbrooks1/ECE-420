 ...
 * or write to a global array of strings which is guarded by a single read-write lock.
 *
 * When running main3, three parameters are expected for string array length, server IP address, and server port,
...
int main(int argc, char *argv[]) {
    ...
    // rwlock = malloc(sizeof(mylib_rwlock_t));
 ...
 *
 * A single read-write lock is used to synchronize access to the string array.
 */
void *handle_request(void *args) {
